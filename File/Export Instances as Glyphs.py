#MenuTitle: Export Instances as GLYPHS
# -*- coding: utf-8 -*-
__doc__="""
Exports all active Instances as GLYPHS.
"""
import GlyphsApp
import commands
from types import *
...
filepath = saveFileDialog( message="Export Instances as UFOs", ProposedFileName=filename, filetypes=["glyphs"] )
