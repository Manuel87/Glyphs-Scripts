#MenuTitle: Edit Previous Glyph, same layer
# -*- coding: utf-8 -*-
from __future__ import division, print_function, unicode_literals
import traceback
from copy import copy

# build upon "Edit Previous Glyph" by Tim Ahrens & "Next Layer in Selection" by Alex Slobzheninov


__doc__="""
Activates the previous glyph in the tab for editing and also stays in the same Layer (any kind of layer, not just masters)
"""
