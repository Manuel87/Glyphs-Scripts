...
class ChangeMetricsbyPercentage( object ):
	def __init__( self ):
		self.w = vanilla.FloatingWindow( (430, 60), "Make Metrics of Selected Glyphs monospaced", minSize=(430, 60), maxSize=(600, 60), autosaveName="com.mekkablue.ChangeMetricsbyPercentage.mainwindow" )
		...
		self.w.changeValue = vanilla.EditText( (180, 12, -196, 15+3), "500.0", sizeStyle = 'small')
