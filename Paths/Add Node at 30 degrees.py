# -*- coding: utf-8 -*-
#MenuTitle: Add Nodes at 30° on Selected Segments
from __future__ import division, print_function, unicode_literals
__doc__ = """
Adds nodes at 30° on selected segments. Interpolation may produce kinks if a node changes the angle AND proportion of its handles between masters. This is not a problem for extremes, but sometimes we need to add intermediate nodes to better control a curve. The easiest way to ensure no kinks will happen in difficult curves is to keep the handles at a constant angle, like 30°.
"""
